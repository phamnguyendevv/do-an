...
export class GetListReceiptsDto {
  @ApiPropertyOptional({
    description: 'Từ khóa tìm kiếm (mã phiếu, NCC, lý do, ghi chú)',
  })
  @IsOptional()
  @IsString()
  search?: string
  ...
  @ApiPropertyOptional({
    description: 'ID nhà cung cấp (chỉ áp dụng cho phiếu nhập)',
  })
  @IsOptional()
  @Type(() => Number)
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Lý do xuất (chỉ áp dụng cho phiếu xuất)',
  })
  @IsOptional()
  @IsString()
  reason?: string
