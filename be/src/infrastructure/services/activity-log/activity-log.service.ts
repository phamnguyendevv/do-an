...
import { ACTIVITY_LOG_SERVICE, IActivityLogService } from '@domain/services/activity-log.service.interface'
...
export class ActivityLogService implements IActivityLogService {
  ...
  async record(payload: Parameters<IActivityLogService['record']>[0]): Promise<void> {
