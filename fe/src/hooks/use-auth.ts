...
export function useAuth() {
  const user = useSyncExternalStore(authStore.subscribe, authStore.get, () => null);
  const hydrated = useSyncExternalStore(authStore.subscribe, authStore.isHydrated, () => false);
